...
function main(){
  ...
  var names = ["IPhone 6 Plus","IPhone 6","IPhone 5","IPhone 4"];
  ...
  for (i = 0; i < 4; i++)
  {
    ...
    var saveFolder = new Folder(outFolder + saveName);
    if (!saveFolder.exists) 
    {
      saveFolder.create();
    }

    var saveFile= File(saveFolder + sF);
